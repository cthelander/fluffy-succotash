...
public class InitVarIntro extends VarIntro {
    ...
    /** for the initGlobals function that is created in the 
        global class function CompileGlob which needs the 
        Expr so that it can compile them for the global variables
     */
    public Expr GetExpr() {
        return exp;
    }
