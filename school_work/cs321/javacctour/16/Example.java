...
//-- Define the grammatical rules of the input language: ---------------------
  static final public int Top() throws ParseException {
              int n;
    n = E();
    jj_consume_token(0);
                {if (true) return n;}
  ...
  static final public int P() throws ParseException {
            int n, m;
    n = A();
    label_2:
    while (true) {
  ...
  static final public int A() throws ParseException {
            int n;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 4:
      jj_consume_token(4);
  ...
  static final public int I() throws ParseException {
            Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6,0x6,0x8,0x1010,};
   }
